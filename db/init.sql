...
INSERT INTO addresses (Fname, Lname, Address, City, State, ZipCode) VALUES
    ...
    ('Jason','Hammond','9824 Lakeshore St.','Fleming Island','FL', 32003),
    ('Paul','Stewart','556 Gartner St.','Westmont','IL', 60559),
    ('Nathan','Mcguire','144 East Bohemia Ave.','Floral Park','NY', 11001),
    ('Kelli','Pope','89 Fulton Rd.','West Des Moines','IA', 50265),
